...
spec = describe "Variable Declarations" $ do
        ...
        U.extractCompoundRecFromExtra extra' `shouldSatisfy`
            (\(ST.CompoundRec
                ...
                (ST.Compound
                    ...
                    (G.IntLit 2))) -> True)
    it "allows declare variables of recursive type `armor of type sign" $ do
    ...
    it "allows declare variables of recursive type `armor of type <n>-chest of type sign" $ do
